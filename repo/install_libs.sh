...
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcublas-natives   -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcublas-natives-$version-linux-ppc_64.jar    -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcuda-natives     -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcuda-natives-$version-linux-ppc_64.jar      -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcufft-natives    -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcufft-natives-$version-linux-ppc_64.jar     -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcurand-natives   -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcurand-natives-$version-linux-ppc_64.jar    -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcusparse-natives -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcusparse-natives-$version-linux-ppc_64.jar  -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcusolver-natives -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcusolver-natives-$version-linux-ppc_64.jar  -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcudnn-natives    -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jcudnn-natives-$version-linux-ppc_64.jar     -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jnvgraph-natives  -Dversion=$version -Dclassifier=linux-ppc_64  -Dfile=jnvgraph-natives-$version-linux-ppc_64.jar   -Durl=file://.
